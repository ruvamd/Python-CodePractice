'''
1.Write a class StreamingMedianCalculator that takes this starting input [1, 16, 7, 9, 14, 27, 34, 15, 61, 43, 52] and 
has a method AddNumberAndReturnMedian.
2.AddNumberAndReturnMedian should take in an integer, and return the median 
of all the numbers seen so far as a double.

starting_input=[1, 16, 7, 9, 14, 27, 34, 15, 61, 43, 52]
