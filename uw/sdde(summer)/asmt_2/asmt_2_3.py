'''
3.-Incorporate use of Singleton pattern in design.
  -Design should be more flexible for future changes.
'''
...
'''
-The Permissions class follows the Singleton pattern, ensuring there is only one instance of the permissions object.
-It's more flexible permissions configuration by using the update_permissions method to modify permissions for groups.
-Users and groups are created with a more simplified approach, and permissions are managed at the group level.
-The FileSystemElement class is updated to handle permissions at the group level and to use the updated Permissions class.
'''